...
- Pneumatic/ventricular models
- Gray matter (production)/white matter (conduction)
- Sensory -> association -> motor neurons
...
## Measuring the connectome

<div class="centered">
<a href="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Connectome.jpg/640px-Connectome.jpg"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Connectome.jpg/640px-Connectome.jpg" height=500px>
</a>
</div>
...
<div class="centered">
<a href="http://www.neuroscienceblueprint.nih.gov/connectome/NIH_Functional-Connectivity-Matrix-full.png"><img src="http://www.neuroscienceblueprint.nih.gov/connectome/NIH_Functional-Connectivity-Matrix-full.png">
</a>
</div>

## Visualizing the connectome

<iframe src="http://humanconnectome.org/software/get-connectome-workbench.html"></iframe>

## Is the connectome enough?

- Why or why not?

## Swanson's recommendations

- Account of all nervous system parts
- Web-based data models for 3D visualization
- Atlases linked to histological sections
- "Rules" for circuit schematics
- Connection matrices
